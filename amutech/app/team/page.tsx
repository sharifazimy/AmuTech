      ...
      <div className="pt-20 bg-white">
        ...
        <section className="bg-slate-50 py-16 md:py-20">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-4xl font-bold mb-6">Global Team. Seamless Execution.</h2>
            <p className="text-lg md:text-xl text-slate-600 px-4">
              With members across Asia, America, and Europe, we combine diverse expertise 
              and work efficiently across time zones to deliver outstanding results.
            </p>
          </div>
        </section>
      </div>
